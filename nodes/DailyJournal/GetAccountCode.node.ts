...
export class GetAccountCode implements INodeType {
    description: INodeTypeDescription = {
        displayName: 'PEAK Get Account Code',
        name: 'getAccountCode',
        icon: 'file:../../assets/PEAK.svg',
        group: ['input'],
        version: 1,
        subtitle: '={{$parameter["operation"]}}',
        description: 'Send parameter to get account code via PEAK API',
        defaults: {
            name: 'Get AccountCode',
        },
        inputs: ['main'],
        outputs: ['main'],
        ...
        properties: [
            {
                ...
                default: 'production',
                required: true,
                description: 'AccountCode ID to retrieve',
                options: [
                    {
                        name: 'UAT',
                        value: 'uat',
    ...
    async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
        ...
        let endpointUrl = 'https://peakengineapidev.azurewebsites.net/api/v1/dailyjournals/accountcode';
