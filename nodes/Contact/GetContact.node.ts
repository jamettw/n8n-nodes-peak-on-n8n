...
export class GetContact implements INodeType {
    description: INodeTypeDescription = {
        displayName: 'PEAK Get Contact',
        name: 'getContact',
    ...
    async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
        ...
        let endpointUrl = 'https://peakengineapidev.azurewebsites.net/api/v1/contacts';
        ...
        for (let itemIndex = 0; itemIndex < items.length; itemIndex++) {
            try {
                ...
                const contactCode = this.getNodeParameter('contactCode', itemIndex, '') as string;
